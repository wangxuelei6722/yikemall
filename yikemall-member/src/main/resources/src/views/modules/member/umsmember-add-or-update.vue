<template>
  <el-dialog
    ...
    <el-form-item label="社交登录UID" prop="socialUid">
      <el-input v-model="dataForm.socialUid" placeholder="社交登录UID"></el-input>
    </el-form-item>
    <el-form-item label="社交登录TOKEN" prop="accessToken">
      <el-input v-model="dataForm.accessToken" placeholder="社交登录TOKEN"></el-input>
    </el-form-item>
    <el-form-item label="社交登录过期时间" prop="expiresIn">
      <el-input v-model="dataForm.expiresIn" placeholder="社交登录过期时间"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          socialUid: [
            { required: true, message: '社交登录UID不能为空', trigger: 'blur' }
          ],
          accessToken: [
            { required: true, message: '社交登录TOKEN不能为空', trigger: 'blur' }
          ],
          expiresIn: [
            { required: true, message: '社交登录过期时间不能为空', trigger: 'blur' }
          ]
        }
      }
    },
